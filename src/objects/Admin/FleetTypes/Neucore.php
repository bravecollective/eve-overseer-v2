<?php
    ...
    class Neucore {
        ...
        private function populateAccess() {
            ...
            $checkQuery = $this->databaseConnection->prepare("SELECT accesstype, roletype, roleid FROM fleettypeaccess WHERE typeid=:typeid AND roletype=:type_core");
